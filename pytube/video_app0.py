...
from PyQt6.QtWidgets import QApplication, QWidget, QVBoxLayout, QPushButton, QLineEdit, QLabel, QListWidget, QTextEdit
...
class VideoDownloaderApp(QWidget):
    ...
    def init_ui(self):
        ...
        self.url_input.setStyleSheet("background-color: #006400;")
